...
var dndMultiBackend = require('dnd-multi-backend');
        ...
        backends: [
            {
                ...
                transition: dndMultiBackend.PointerTransition,
            },
            {
                id: "touch",
...
var Providers = function (props) { return (React__default["default"].createElement(TreeProvider, __assign({}, props),
    React__default["default"].createElement(DragControlProvider, null,
        React__default["default"].createElement(PlaceholderProvider, null, props.children)))); };
...
Object.defineProperty(exports, 'MultiBackend', {
    enumerable: true,
    get: function () { return dndMultiBackend.MultiBackend; }
});
Object.defineProperty(exports, 'DndProvider', {
    enumerable: true,
    get: function () { return reactDnd.DndProvider; }
});
